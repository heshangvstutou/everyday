...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            /// M:
            Log.d(TAG, " jlink ----v TetherChangeReceiver - onReceive, action is " + action);
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
                ...
                /// M: print log
                Log.d(TAG, "jlink mUsbUnTetherDone? :" + mUsbUnTetherDone + " , mUsbTetherDonel? :" +
                ...
                Log.d(TAG, "jlink ------v  TetherChangeReceiver - ACTION_USB_STATE mUsbConnected: "
                    + mUsbConnected +
    ...
    private void updateUsbState(String[] available, String[] tethered,
        ...
        for (String s : tethered) {
            for (String regex : mUsbRegexs) {
                Log.d(TAG,"jlink ------ s"+s+"regex:"+regex);
		if (s.matches(regex)) usbTethered = true;
	     	Log.d(TAG,"jlink usbTethered..........................");
            }
        }
        ...
        Log.d(TAG, "jlink 111111 updateUsbState - usbTethered : " + usbTethered + " usbErrored: " +
        ...
        if (usbTethered) {
             ...
             */
            Log.d(TAG, "jlink 2222222 updateUsbState: usbTethered ! mUsbTether checkbox setEnabled & checked ");
            ...
            Log.d(TAG,"jlink 3333333 updateUsbState - usbTethered - mUsbTetherCheckEnable: "
            ...
            if (mUsbTetherCheckEnable) {
                Log.d(TAG, "jlink   44444444 updateUsbState - mUsbTetherCheckEnable, " +
            ...
            Log.d(TAG, "jlink    555555555 updateUsbState - usbAvailable - mUsbConfigured:  " + mUsbConfigured +
                    " mUsbTethering: " + mUsbTethering +
                    " mUsbTetherCheckEnable: " + mUsbTetherCheckEnable);
        } else if (usbErrored) {
	    //USB网络共享出错
	    Log.d(TAG,"jlink 66666666 usbErrored: "+usbErrored);
            mUsbTether.setSummary(R.string.usb_tethering_errored_subtext);
		...
		mUsbTether.setSummary(R.string.usb_tethering_unavailable_subtext);
                ...
                /// M: update usb state @{
		//选中即可共享网络
                Log.d(TAG, "jlink 888888888888888  updateUsbState - else, " +
                    "mUsbTether checkbox setEnabled, and set unchecked ");
                mUsbTether.setSummary(R.string.usb_tethering_available_subtext);
                mUsbTether.setEnabled(true);
                mUsbTether.setChecked(false);
            ...
            Log.d(TAG, "jlink 999999999999999  updateUsbState- usbAvailable- mUsbHwDisconnected:" + mUsbHwDisconnected);
        }
    }
