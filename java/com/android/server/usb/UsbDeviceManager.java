...
public class UsbDeviceManager {
    ...
    private static final int MSG_ENABLE_ACM = 8;

    // C2K-BYPASS-START
    private static final int MSG_SET_BYPASS_MODE = 9;
    private static final int MSG_SET_BYPASS = 10;
    ...
    private final class UsbHandler extends Handler {
        ...
        private void setEnabledFunctions(String functions, boolean forceRestart) {
            ...
            if (mIsUsbSimSecurity) {
                ...
                if (value.equals("no") && (functions != null)) {
                    Slog.d(TAG, "Usb is non-activated!");
                    trySetEnabledFunctions(UsbManager.USB_FUNCTION_NONE, false);
                    return;
                }
            }
	    ...
	    Slog.d(TAG,"jlink oldFunctions ="+mCurrentFunctions+"    oldoldFunctionsApplied="+oldFunctionsApplied);
        ...
        private boolean trySetEnabledFunctions(String functions, boolean forceRestart) {
            if (functions == null) {
                ...
                // C2K-BYPASS-END
		// jlink zhangjie add: when functions equals null ,set usb to USB_FUNCTION_NONE,
                functions= UsbManager.USB_FUNCTION_NONE;
		mConnected= false;
		//functions = getDefaultFunctions();
		Slog.d(TAG,"jlink  trySetEnabledFunctions  functions "+functions);
		//jlink zhangjie end
            }
            // C2K-BYPASS-START
            if (bEvdoDtViaSupport == true) {
